...
def test_quadratic_form_class_number_naive_A014602():
    """
    Notes:
    ...
    for d in correct:
        assert len(list(quadratic_form_class_number_naive(-d))) == 1


def test_quadratic_form_class_number_naive_A014603():
    """
    Notes:
    ...
    for d in correct:
        assert len(list(quadratic_form_class_number_naive(-d))) == 2


def test_quadratic_form_class_number_naive_A006203():
    """
    Notes:
    ...
    for d in correct:
        assert len(list(quadratic_form_class_number_naive(-d))) == 3
