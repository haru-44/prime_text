...
このとき、\IND{1次合同方程式}{1しこうとうほうていしき}(linear congruence)
...
\Algo{1次合同方程式}{linear_congruence}{c.f., \rAlgo{extended_gcd}}

閑話休題\Notes{閑話休題は閑話の意味で使われる場合があるが、本来は閑話から本題に戻るときに使う。ここでは本来の意味で使用している。}。
