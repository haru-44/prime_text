...
\Algo{楕円曲線上の点を枚挙する}{elliptic_curve_points}{c.f., \rAlgo{jacobi_symbol}, \rAlgo{tonelli_shanks_algorithm}}

\Algo{楕円曲線の位数}{elliptic_curve_order_naive}{c.f., \rAlgo{jacobi_symbol}}
